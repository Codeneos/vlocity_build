                    ...
                    self.vlocity.datapacks.getDataPackData(result.VlocityDataPackId, function(dataPackData) {
                        ...
                        (dataPackData.dataPacks || []).forEach(function(dataPack) {
                            ...
                            if (dataPack.VlocityDataPackStatus == 'Success') {
                                ...
                                var errorMessage = dataPack.VlocityDataPackType + ' --- ' + dataPack.VlocityDataPackName + ' --- ' + (dataPack.VlocityDataPackMessage ? dataPack.VlocityDataPackMessage.trim() : '') + (dataPack.VlocityDataPackStatus == 'Ignored' ? ' --- Ignored' : '');
                        ...
                        originalKeys.forEach(function(pack){
                            if (pack.VlocityDataPackKey && !processedKeys[pack.VlocityDataPackKey]) {
                                VlocityUtils.log('\x1b[31m', 'Ignored:', '\x1b[0m', pack.VlocityDataPackKey);

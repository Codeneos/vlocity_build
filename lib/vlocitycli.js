...
VlocityCLI.prototype.runTestJob = function(dataPacksJobsData, success, error) {
    ...
    async.eachSeries(commands, function(command, callback) {
        ...
        self.runJob(JSON.parse(JSON.stringify(dataPacksJobsData)), 'TestJob', command, function(result) {
            var hasErrors = false;
            ...
            result.records.forEach(function(record) {
                ...
                } else if (record.VlocityDataPackStatus != 'Success') {
                    VlocityUtils.log('Error', record.VlocityDataPackKey, record.VlocityDataPackStatus);
                    hasErrors = true;
                }
            });
